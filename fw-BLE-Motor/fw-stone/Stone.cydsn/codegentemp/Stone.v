// ======================================================================
// Stone.v generated from TopDesign.cysch
// 02/22/2017 at 10:13
...
module BLE_v3_10_0 (
	...
	cy_clock_v1_0
		#(.id("0b976852-d9ad-493c-8f07-2c139abd0f7a/5ae6fa4d-f41a-4a35-8821-7ce70389cb0c"),
...
// Timer_v2_70(CaptureAlternatingFall=false, CaptureAlternatingRise=false, CaptureCount=2, CaptureCounterEnabled=false, CaptureInputEnabled=false, CaptureMode=0, CONTROL3=0, ControlRegRemoved=0, CtlModeReplacementString=SyncCtl, CyGetRegReplacementString=CY_GET_REG16, CySetRegReplacementString=CY_SET_REG16, DeviceFamily=PSoC4, EnableMode=0, FF16=false, FF8=false, FixedFunction=false, FixedFunctionUsed=0, HWCaptureCounterEnabled=false, InterruptOnCapture=false, InterruptOnFIFOFull=false, InterruptOnTC=false, IntOnCapture=0, IntOnFIFOFull=0, IntOnTC=0, NumberOfCaptures=1, param45=1, Period=4095, RegDefReplacementString=reg16, RegSizeReplacementString=uint16, Resolution=16, RstStatusReplacementString=rstSts, RunMode=0, SiliconRevision=0, SoftwareCaptureModeEnabled=false, SoftwareTriggerModeEnabled=false, TriggerInputEnabled=false, TriggerMode=0, UDB16=true, UDB24=false, UDB32=false, UDB8=false, UDBControlReg=true, UsesHWEnable=0, VerilogSectionReplacementString=sT16, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMPONENT_NAME=Timer_v2_70, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=Stone_Timer, CY_INSTANCE_SHORT_NAME=Stone_Timer, CY_MAJOR_VERSION=2, CY_MINOR_VERSION=70, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator No Version Information Found, INSTANCE_NAME=Stone_Timer, )
...
module top ;
	...
	cy_psoc3_pins_v1_10
		#(.id("382cd073-392d-4e3c-a298-cb0507ae26b4"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
    ...
    PWM_v3_30_1 Stone_PWM (
        ...
        .ph1(Net_204),
        .ph2(Net_205));
    defparam Stone_PWM.Resolution = 16;


	cy_clock_v1_0
		#(.id("86fbf3e5-e567-436e-8120-fe102bf03f8f"),
		  .source_clock_id(""),
		  .divisor(0),
		  .period("10000000000"),
		  .is_direct(0),
    ...
    Timer_v2_70_2 Stone_Timer (
        ...
        .tc(Net_165),
        .clock(Net_10));
    defparam Stone_Timer.CaptureCount = 2;
    defparam Stone_Timer.CaptureCounterEnabled = 0;
    defparam Stone_Timer.DeviceFamily = "PSoC4";
    defparam Stone_Timer.InterruptOnCapture = 0;
    defparam Stone_Timer.InterruptOnTC = 0;
    defparam Stone_Timer.Resolution = 16;
    defparam Stone_Timer.SiliconRevision = "0";
	...
	cy_psoc3_pins_v1_10
		#(.id("de0a64c7-ea1c-46b8-9959-db5d60aa9f96"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
