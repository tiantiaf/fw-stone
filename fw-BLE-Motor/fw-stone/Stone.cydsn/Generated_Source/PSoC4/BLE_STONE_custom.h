...
#define CYBLE_STONE_BLE_SERVICE_INDEX   (0x00u) /* Index of STONE_BLE service in the cyBle_customs array */
#define CYBLE_STONE_BLE_CTR_LED_CHAR_INDEX   (0x00u) /* Index of CTR_LED characteristic */
#define CYBLE_STONE_BLE_CTR_LED_CHARACTERISTIC_USER_DESCRIPTION_DESC_INDEX   (0x00u) /* Index of Characteristic User Description descriptor */
#define CYBLE_STONE_BLE_CTR_MOTOR_CHAR_INDEX   (0x01u) /* Index of CTR_MOTOR characteristic */
#define CYBLE_STONE_BLE_CTR_MOTOR_CHARACTERISTIC_USER_DESCRIPTION_DESC_INDEX   (0x00u) /* Index of Characteristic User Description descriptor */


#define CYBLE_STONE_BLE_SERVICE_HANDLE   (0x000Eu) /* Handle of STONE_BLE service */
#define CYBLE_STONE_BLE_CTR_LED_DECL_HANDLE   (0x000Fu) /* Handle of CTR_LED characteristic declaration */
#define CYBLE_STONE_BLE_CTR_LED_CHAR_HANDLE   (0x0010u) /* Handle of CTR_LED characteristic */
#define CYBLE_STONE_BLE_CTR_LED_CHARACTERISTIC_USER_DESCRIPTION_DESC_HANDLE   (0x0011u) /* Handle of Characteristic User Description descriptor */
#define CYBLE_STONE_BLE_CTR_MOTOR_DECL_HANDLE   (0x0012u) /* Handle of CTR_MOTOR characteristic declaration */
#define CYBLE_STONE_BLE_CTR_MOTOR_CHAR_HANDLE   (0x0013u) /* Handle of CTR_MOTOR characteristic */
#define CYBLE_STONE_BLE_CTR_MOTOR_CHARACTERISTIC_USER_DESCRIPTION_DESC_HANDLE   (0x0014u) /* Handle of Characteristic User Description descriptor */
