...
#define CYBLE_BLE_LED_SERVICE_INDEX   (0x00u) /* Index of BLE_LED service in the cyBle_customs array */
#define CYBLE_BLE_LED_CTR_LED_CHAR_INDEX   (0x00u) /* Index of CTR_LED characteristic */
#define CYBLE_BLE_LED_CTR_LED_CHARACTERISTIC_USER_DESCRIPTION_DESC_INDEX   (0x00u) /* Index of Characteristic User Description descriptor */


#define CYBLE_BLE_LED_SERVICE_HANDLE   (0x000Eu) /* Handle of BLE_LED service */
#define CYBLE_BLE_LED_CTR_LED_DECL_HANDLE   (0x000Fu) /* Handle of CTR_LED characteristic declaration */
#define CYBLE_BLE_LED_CTR_LED_CHAR_HANDLE   (0x0010u) /* Handle of CTR_LED characteristic */
#define CYBLE_BLE_LED_CTR_LED_CHARACTERISTIC_USER_DESCRIPTION_DESC_HANDLE   (0x0011u) /* Handle of Characteristic User Description descriptor */
