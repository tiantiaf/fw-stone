...
const CYBLE_GATTS_DB_T cyBle_gattDB[0x10u] = {
    ...
    { 0x000Eu, 0xCAA1u /* CapSense Proximity                  */, 0x00011000u /* ntf    */, 0x0010u, {{0x0001u, (void *)&cyBle_attValuesLen[5]}} },
    { 0x000Fu, 0x2902u /* Client Characteristic Configuration */, 0x00010A26u /* rd,wr  */, 0x000Fu, {{0x0002u, (void *)&cyBle_attValuesLen[6]}} },
    { 0x0010u, 0x2901u /* Characteristic User Description     */, 0x00010201u /* rd     */, 0x0010u, {{0x0012u, (void *)&cyBle_attValuesLen[7]}} },
};
