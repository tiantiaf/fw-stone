    ...
    switch (event)
	{
		...
		***********************************************************/
    	...
    	case CYBLE_EVT_GATTS_WRITE_REQ:
    		...
    		if (CYBLE_BLE_LED_CTR_LED_CHAR_HANDLE == wrReqParam->handleValPair.attrHandle)
    		{
            ...
            if (CYBLE_BLE_LED_CTR_LED_CHARACTERISTIC_USER_DESCRIPTION_DESC_HANDLE == wrReqParam->handleValPair.attrHandle)
            {
...
{
    setHandle.attrHandle = CYBLE_BLE_LED_CTR_LED_CHAR_HANDLE;
